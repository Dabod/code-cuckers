...
public class Partida {
	...
	public void reglasJuego() {
		...
		System.out.println("1 - Se necesita un minimo de 3 equipos para jugar y no hay limite maximo --> (1.000.000.000 equipos Por limitaciones del programa).");
		System.out.println("2 - Los equipos tienen diferentes tipos que cambian sus estadisticas y estilo de juego.");
		System.out.println("3 - Se puede atacar a diferentes equipos con diferentes ataques.");
		System.out.println("4 - Cuando las vidas de un equipo llegan a 0 muere.");
	...
	public void infoJuego() {
		...
		System.out.println("Contacto: guepardar@gmail.com, marcvaldiviaprim99@gmail.com, sergipaz17@gmail.com.");
		System.out.println("Autores: David Alba, Marc Valdivia, Sergi Paz\n");
		parar(2000);
	...
	public void opcionesReproductor() {
		...
		System.out.println("Desde aqui se podría configurar el reproductor (Cuando haya uno).");
		parar(2000);
